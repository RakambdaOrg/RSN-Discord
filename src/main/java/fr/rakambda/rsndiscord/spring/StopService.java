...
public class StopService{
	...
	public void shutdown(@NonNull JDA jda) throws InterruptedException, ExecutionException, TimeoutException{
	...
	@NonNull
	private CompletableFuture<Void> resetCommands(@NonNull JDA jda){
