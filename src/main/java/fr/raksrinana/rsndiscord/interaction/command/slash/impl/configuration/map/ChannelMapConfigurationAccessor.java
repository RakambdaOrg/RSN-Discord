package fr.raksrinana.rsndiscord.interaction.command.slash.impl.configuration.map;

import fr.raksrinana.rsndiscord.interaction.command.slash.impl.configuration.MapConfigurationAccessor;
