...
public enum BasicEmotes implements Comparable<BasicEmotes>{
	A("\uD83C\uDDE6", "a"), B("\uD83C\uDDE7", "b"), C("\uD83C\uDDE8", "c"), D("\uD83C\uDDE9", "d"), E("\uD83C\uDDEA", "e"), F("\uD83C\uDDEB", "f"), G("\uD83C\uDDEC", "g"), H("\uD83C\uDDED", "h"), I("\uD83C\uDDEE", "i"), J("\uD83C\uDDEF", "j"), K("\uD83C\uDDF0", "k"), L("\uD83C\uDDF1", "l"), M("\uD83C\uDDF2", "m"), N("\uD83C\uDDF3", "n"), O("\uD83C\uDDF4", "o"), P("\uD83C\uDDF5", "p"), Q("\uD83C\uDDF6", "q"), R("\uD83C\uDDF7", "r"), S("\uD83C\uDDF8", "s"), T("\uD83C\uDDF9", "t"), U("\uD83C\uDDFA", "u"), V("\uD83C\uDDFB", "v"), W("\uD83C\uDDFC", "w"), X("\uD83C\uDDFD", "x"), Y("\uD83C\uDDFE", "y"), Z("\uD83C\uDDFF", "z"), THUMB_UP("\uD83D\uDC4D"), THUMB_DOWN("\uD83D\uDC4E"), ERROR(""), CHECK_OK("✅"), CROSS_NO("❌"), OK_HAND("👌"), PACKAGE("\uD83D\uDCE6"), PAPERCLIP("\uD83D\uDCCE");
