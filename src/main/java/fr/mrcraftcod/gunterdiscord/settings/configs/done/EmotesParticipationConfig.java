 ...
 * @since 2018-04-15
 */
public class EmotesParticipationConfig extends MapMapConfiguration<String, String, Long>{
	/**
	 * Constructor.
	 *
	 * @param guild The guild for this config.
	 */
	public EmotesParticipationConfig(@Nullable final Guild guild){
		super(guild);
	}
