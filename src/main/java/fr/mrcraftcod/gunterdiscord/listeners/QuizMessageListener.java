...
public class QuizMessageListener extends ListenerAdapter implements Runnable
{
	...
	public void run()
	{
		...
		Actions.sendMessage(quizChannel, "Ok @here, j'espère que vous êtes aussi chaud que mon chalumeau pour un petit kwizzz!\n" + "Le principe est simple: une question va apparaitre avec un set de réponses possibles. Vous pouvez répondre à la question en ajoutant une réaction avec la lettre coreespondante. Le temps limite pour répondre est de 15s.\n" + "Chaque bonne réponse vous donnera 1 point.\n\nOn commence dans 2minutes!");
		try
		{
		...
		Actions.sendMessage(quizChannel, "Encore 1 minute! " + Utilities.getEmoteMention("cookie"));
